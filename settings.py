...
ABOUT_STRINGS = ["GraphHelper - Приложение для работы с графами, их    построения и выполнения ряда операций над ними.", \
    "При создании использовались:\n•tkinter", \
    "Звягин Сергей Алексеевич, студент группы КИ19-08б    Института космических и информациооных технологий    Сибирского федерального университета"
    ]
